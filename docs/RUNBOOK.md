...
Measured on RTX 5070 Ti without `--nmm-use-cans`: ~1.11 s/step, 8.5
GiB peak. The `--nmm-use-cans` flag swaps NS5 for 3-step
CANS-stationary (arxiv 2506.10935) — ~1.6× faster NS5 with ~4.6×
better orthogonalisation at gpt2_small dims. Drop the flag if you
need paper-faithful NS5.
